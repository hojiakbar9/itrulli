  ...
  return (
    <div className="bg-background min-h-screen pb-20">
      ...
      <section className="relative py-24 px-6 overflow-hidden">
        ...
        <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-[#93C572]/10 rounded-full blur-3xl -z-10 translate-x-1/3 -translate-y-1/4"></div>
        ...
        <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {JOBS.map((jobId) => (
              <div
                key={jobId}
                className="bg-white rounded-2xl p-8 border border-stone-200 flex flex-col hover:border-primary transition-colors group"
              >
                <div className="mb-4">
