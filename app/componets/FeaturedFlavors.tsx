...
/* Mock Data - In a real app, this could come from Sanity CMS */
const FLAVORS = [
  {
    id: "pistachio",
    image: "/scoop-pistachio.png", // You will need these images
    color: "bg-[#93C572]", // Pistachio Green
    isVegan: false,
    allergens: ["G", "H"], // Milk, Nuts
  },
  {
    id: "chocolate",
    image: "/scoop-chocolate.png",
    color: "bg-[#3B2F2F]", // Dark Chocolate
    isVegan: true,
    allergens: [],
  },
  {
    id: "lemon",
    image: "/scoop-lemon.png",
    color: "bg-[#F4E04D]", // Lemon Yellow
    isVegan: true,
    allergens: [],
  },
  {
    id: "stracciatella",
    image: "/scoop-straccia.png",
    color: "bg-[#E7E5E4]", // Stone/White
    isVegan: false,
    allergens: ["G"], // Milk
  },
];
...
export default function FeaturedFlavors({ locale }: FeaturedProps) {
    ...
    <section className="py-20 bg-stone-50 overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* snap-x: Enables snapping
            ...
            no-scrollbar: Utility we will add to hide ugly scrollbars 
        */}
